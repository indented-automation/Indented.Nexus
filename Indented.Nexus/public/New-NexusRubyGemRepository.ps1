function New-NexusRubyGemRepository {
    <#
    .SYNOPSIS
    ...
    begin {
        $scriptName = 'psNewRubyGemRepository'
        ...
        $params = @{
            ...
            Content    = @(
                ...
                'repository.createRubygemsHosted(name, blob_store_name, strict_content_validation.toBoolean(), policy)'
            )
    ...
    process {
        ...
        if ($pscmdlet.ShouldProcess(('Creating Ruby Gem respository {0}' -f $Name))) {
